...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.GIS.Size = New System.Drawing.Size(585, 437)
            Me.GIS.TabIndex = 0
            '
            'panel1
            '
...
#End Region
        ...
        Private Sub WinForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            shp.AddPart()
            shp.AddPoint(GisUtils.GisPoint(-45, -45))
            ...
            ll.Params.Labels.FontColor = (New TGIS_Color).Black
            ll.Params.Labels.Allocator = False
            ...
            shp.AddPart()
            shp.AddPoint(GisUtils.GisPoint(-90, 90))
            shp.AddPoint(GisUtils.GisPoint(180, -90))
