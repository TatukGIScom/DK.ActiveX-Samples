...
Namespace GridToVector
    Public Class WinForm
        ...
        Private GIS_Attr As AxTatukGIS_XDK11.AxTGIS_ControlAttributes
        ...
        Private Sub InitializeComponent()
            ...
            Me.GIS_Attr = New AxTatukGIS_XDK11.AxTGIS_ControlAttributes()
        ...
        Private Sub btnLoadDEM_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnLoadDEM.Click
            ...
            lp.GenerateRamp_2((New TGIS_Color).Blue, (New TGIS_Color).Lime, (New TGIS_Color).Red, lp.MinHeight, (lp.MinHeight + lp.MaxHeight) / 2, lp.MaxHeight, True, (lp.MaxHeight - lp.MinHeight) / 100, (lp.MaxHeight - lp.MinHeight) / 10, Nothing, True, TGIS_ColorInterpolationMode.HSL)
        ...
        Private Sub doBusyEvent(Pos As Integer, [End] As Integer, ByRef Abort As Boolean)
            Select Case Pos
                Case 0
                    ...
                    pProgressBar.Maximum = CInt([End])
                    pProgressBar.Value = CInt(Pos)
                Case -1
        ...
        Private Sub GIS_MouseDownEvent(sender As Object, e As AxTatukGIS_XDK11.ITGIS_ViewerWndEvents_MouseDownEvent) Handles GIS.MouseDownEvent
            ...
            shp = TryCast(GIS.Locate(GIS.ScreenToMap(GisUtils.Point(e.x, e.y)), 5 / GIS.Zoom), TGIS_Shape)
        ...
        Private Sub GIS_MouseWheel(sender As Object, e As AxTatukGIS_XDK11.ITGIS_ViewerWndEvents_MouseWheelEvent) Handles GIS.MouseWheelEvent
            ...
            If e.wheelDelta < 0 Then
                GIS.ZoomBy(2 / 1.0, pt.X, pt.Y)
            Else
                GIS.ZoomBy(1 / 2.0, pt.X, pt.Y)
            End If
        End Sub
        ...
        Private Sub btnGridToPolygon_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnGridToPolygon.Click
            ...
            lp = TryCast(GIS.Items.Item(0), TGIS_LayerPixel)
            ...
            lv.Transparency = 50
            lv.Params.Area.OutlineColor = (New TGIS_Color).Black
        ...
        Private Sub btnGridToPoint_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnGridToPoint.Click
            ...
            lv.AddField(LV_FIELD, TGIS_FieldType.Float, 0, 0)
            lv.Params.Marker.Color = (New TGIS_Color).Black
