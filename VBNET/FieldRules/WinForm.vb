...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            'GIS
            '
            Me.GIS.Location = New System.Drawing.Point(25, 27)
            Me.GIS.Name = "GIS"
            Me.GIS.OcxState = CType(resources.GetObject("GIS.OcxState"), System.Windows.Forms.AxHost.State)
            Me.GIS.Size = New System.Drawing.Size(100, 100)
            Me.GIS.TabIndex = 4
            '
            'WinForm
            '
...
#End Region
        ...
        Private Sub btnAlias_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAlias.Click
            ...
            Dim shp As TGIS_Shape
            Dim fva As New TGIS_FieldValueAlias
            fld = lv.FieldInfo(0)
            r = New TGIS_FieldRule
            fva.Create_("Tommy", "Tom")
            r.ValueAliases.Aliases.Add(fva)
            fld.Rules = r
            shp = lv.GetShape(1)
            shp.SetField("name", "Tom")
            GIS_Attributes.ShowShape(shp)
        ...
        Private Sub btnCheck_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCheck.Click
            ...
            Dim fld As TGIS_FieldInfo
            Dim shp As TGIS_Shape
            Dim fvc As New TGIS_FieldValueCheck
            fld = lv.FieldInfo(0)
            r = New TGIS_FieldRule
            fvc.Create_(TGIS_FieldValueCheckMode.AfterEdit, TGIS_FieldValueCheckFormula.Required, "", "Cannot be null")
            r.ValueChecks.Checks.Add(fvc)
            fld.Rules = r
            shp = lv.GetShape(1)
            Try
                shp.SetField("name", "")
        ...
        Private Sub btnDefault_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnDefault.Click
            ...
            shp = lv.CreateShape(TGIS_ShapeType.Point)
            shp.AddPart()
            shp.AddPoint(GisUtils.GisPoint(30, 20))
        ...
        Private Sub btnValidate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnValidate.Click
            ...
            fld = lv.FieldInfo(1)
            r = New TGIS_FieldRule
            fvc.Create_(TGIS_FieldValueCheckMode.AfterEdit, TGIS_FieldValueCheckFormula.Regex, EMAIL_REGEX, "Invalid email")
            r.ValueChecks.Checks.Add(fvc)
            fld.Rules = r
            shp = lv.GetShape(1)
        ...
        Private Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSave.Click
            Dim fro As New TGIS_FieldRulesOperations
            fro.SaveFldx(("myrules" + GIS_FLDX_EXT), lv)
        End Sub

        Private Sub btnRead_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRead.Click
            Dim shp As TGIS_Shape
            Dim fro As New TGIS_FieldRulesOperations
            fro.ParseFldx(("myrules" + GIS_FLDX_EXT), lv)
            shp = lv.GetShape(1)
            GIS_Attributes.ShowShape(shp)
        End Sub
    End Class
