...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.stsBar.Panels.AddRange(New System.Windows.Forms.StatusBarPanel() {Me.statusBarPanel1, Me.statusBarPanel2})
...
#End Region
        ...
        Private Sub SearchForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Do While i < mainForm.GIS.Items.Count
                If Not (TypeOf mainForm.GIS.Items.Item(i) Is TGIS_LayerVector) Then
                    i += 1
                    Continue Do
                End If

                lv = CType(mainForm.GIS.Items.Item(i), TGIS_LayerVector)
            ...
            If cbLayer.Items.Count > 0 Then
                ...
                lv = CType(mainForm.GIS.Items.Item(cbLayer.SelectedIndex), TGIS_LayerVector)
                j = 0
...
Continue1:
                ...
                stsBar.Panels(1).Text = cbLayer.Items(cbLayer.SelectedIndex).ToString()
            Else
...
Continue1:
        ...
        Private Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
            ...
            ' get selected layer
            ll = CType(mainForm.GIS.Items.Item(cbLayer.SelectedIndex), TGIS_LayerVector)
