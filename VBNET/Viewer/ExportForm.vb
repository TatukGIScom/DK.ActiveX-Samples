...
#End Region
        ...
        Private Sub ExportForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            For i = mainForm.GIS.Items.Count - 1 To 0 Step -1
                ll = CType(mainForm.GIS.Items.Item(i), TGIS_Layer)
            ...
            If (Not CType(mainForm.GIS.Get(cmbLayersList.Text), ITGIS_Layer) Is Nothing) Then
                CS = CType(mainForm.GIS.Get(cmbLayersList.Text), ITGIS_Layer).CS
                edCS.Text = CS.WKT
            End If
        End Sub
        ...
        Private Sub cmbLayersList_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbLayersList.SelectedIndexChanged
            ...
            la = mainForm.GIS.Get(cmbLayersList.Text)
            CS = CType(la, ITGIS_Layer).CS
            edCS.Text = CS.WKT
        End Sub
    End Class
End Namespace
