...
Namespace PixelFilters
    Public Class WinForm
        ...
        Private GIS As AxTGIS_ViewerWnd
        Private pProgress As ProgressBar
        Private GIS_Legend As AxTGIS_ControlLegend
        ...
        Private Sub open()
            ...
            GIS.Close()
            ll = CType((GisUtils.GisCreateLayer("", GisUtils.GisSamplesDataDirDownload() & "World\Countries\USA\States\California\San Bernardino\NED\w001001.adf")), TGIS_LayerPixel)
            ll.Open()
        ...
        Private Sub btnExecute_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExecute.Click
            ...
            input = CType((GIS.Items.Item(0)), TGIS_LayerPixel)
