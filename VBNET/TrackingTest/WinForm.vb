...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.panel1.Size = New System.Drawing.Size(586, 29)
...
#End Region
        ...
        Private Sub WinForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            ll.Params.Line.Symbol = GisUtils.SymbolList.Prepare(GisUtils.GisSamplesDataDirDownload() & "\Symbols\1301.cgm")
            ...
            rnd = New Random()
            For i = 0 To 100
                shp = (CType(GIS.Items.Item(1), TGIS_LayerVector)).CreateShape(TGIS_ShapeType.Point)
                n = i + 1
                ...
                shp.AddPart()
                shp.AddPoint(GisUtils.GisPoint(-180 + rnd.Next(360), (90 - rnd.Next(180))))
                shp.Unlock()
            Next i
        End Sub
            ...
            For i = 0 To 90
                ...
                For j = 1 To 90
                    If Me.IsDisposed Then
                        Exit For
                    End If
                    shp = (CType(GIS.Items.Item(1), TGIS_LayerVector)).GetShape(j)
                    pt = shp.Centroid()

                    delta = j Mod 3 - 1
                    shp.SetPosition(GisUtils.GisPoint(pt.X + delta, pt.Y), Nothing, 0)
