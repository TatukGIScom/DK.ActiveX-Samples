...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.textBox1.Size = New System.Drawing.Size(260, 300)
...
#End Region
        ...
        Public Sub ShowMatches(ByVal _resolvedAddresses As TGIS_ObjectList, ByVal _resolvedAddresses2 As TGIS_ObjectList)
            Dim i, j As Integer
            Dim strings As TGIS_StringList
            textBox1.Clear()
            If Not _resolvedAddresses Is Nothing Then
                ...
                Do While i < _resolvedAddresses.Count
                    ...
                    End If
                    strings = CType(_resolvedAddresses.Item(i), TGIS_StringList)
                    j = 0
                    Do While j < strings.Count
                        textBox1.AppendText(strings.Strings(j) & Constants.vbCrLf)
                        j += 1
                    Loop
            ...
            If Not _resolvedAddresses2 Is Nothing Then
                ...
                Do While i < _resolvedAddresses2.Count
                    ...
                    Else
                        textBox1.AppendText("------------------------" & Constants.vbCrLf)
                    End If
                    strings = CType(_resolvedAddresses2.Item(i), TGIS_StringList)
                    j = 0
                    Do While j < strings.Count
                        textBox1.AppendText(strings.Strings(j) & Constants.vbCrLf)
                        j += 1
