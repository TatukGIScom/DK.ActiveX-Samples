...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.panel1.Size = New System.Drawing.Size(596, 29)
            Me.panel1.TabIndex = 1
            '
            'progressBar1
            '
            Me.progressBar1.Anchor = System.Windows.Forms.AnchorStyles.Top
            Me.progressBar1.Location = New System.Drawing.Point(179, 2)
            ...
            Me.panel2.Location = New System.Drawing.Point(355, 29)
            ...
            Me.GIS.Size = New System.Drawing.Size(355, 437)
            Me.GIS.TabIndex = 3
            '
            'GIS_ControlScale
            '
            ...
            Me.GIS_ControlScale.Size = New System.Drawing.Size(145, 30)
...
#End Region
        ...
        Private Sub openCoverage(ByVal _path As String)
            ...
            layerSrc = CType(GIS.Items.item(0), TGIS_LayerVector)
            ...
            layerSrc.Params.Labels.Color = (New TGIS_Color).Black
            ...
            layerResult.Params.Line.Color = (New TGIS_Color).Red
            ...
            geoObj.LoadFormulas(GisUtils.GisSamplesDataDirDownload() & "\Samples\Geocoding\us_addresses.geo", GisUtils.GisSamplesDataDirDownload() & "\Samples\Geocoding\tiger2008.geo", "")
        ...
        Private Sub Busy(sender As Object, _e As AxTatukGIS_XDK11.ITGIS_ViewerWndEvents_BusyEventEvent)
            ' show progress
            If _e.Pos = 0 Then
        ...
        Private Sub btnOpenDefault_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOpenDefault.Click
            openCoverage(GisUtils.GisSamplesDataDirDownload() & "\World\Countries\USA\States\California\San Bernardino\TIGER\tl_2008_06071_edges_trunc.SHP")
        End Sub
        ...
        Private Function parse(ByVal _findFirst As Boolean, ByVal _extendedScope As Boolean) As Integer
            Dim resolvedAddresses As TGIS_ObjectList = Nothing
            Dim resolvedAddresses2 As TGIS_ObjectList = Nothing
            ...
            Try
                If geoObj.Match(edtAddress.Text, resolvedAddresses, resolvedAddresses2) Then
                    ...
                    res = geoObj.ParseEx_2(resolvedAddresses, resolvedAddresses2, _findFirst, _extendedScope, True)
        ...
        Private Sub findAddress(ByVal _findFirst As Boolean, ByVal _extendedScope As Boolean)
            ...
            Do While i <= r
                ...
                shp.Params.Marker.Color = (New TGIS_Color).Yellow
                shp.Unlock()
                i += 1
            Loop
            lstMemo.EndUpdate()
