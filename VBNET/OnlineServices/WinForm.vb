...
Namespace OnlineServices
    ...
    Public Class WinForm
        ...
        Friend WithEvents GIS_Scale As AxTatukGIS_XDK11.AxTGIS_ControlScale
...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.GIS_Scale = New AxTatukGIS_XDK11.AxTGIS_ControlScale()
            ...
            CType(Me.GIS_Scale, System.ComponentModel.ISupportInitialize).BeginInit()
            Me.SuspendLayout()
            '
            'grpbxMap
            '
            ...
            CType(Me.GIS_Scale, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
        ...
        Private Function resizeExtent(ByVal _ext As TGIS_Extent, ByVal _siz As Double) As TGIS_Extent
            ...
            Return GisUtils.GisExtent(ctr.X - 0.5D * _siz, ctr.Y - 0.5D * _siz,
        ...
        Private Sub loadTiles(ByVal _style As MapStyle)
            ...
            Dim path As String = GisUtils.GisSamplesDataDirDownload() + "\Samples\WebServices\"
            Select Case _style
        ...
        Private Sub WinForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            GIS_Scale.GIS_Viewer = GIS.GetOcx
        ...
        Private Sub btnRouting_Click(sender As Object, e As EventArgs) Handles btnRouting.Click
            ...
            Dim names As TGIS_StringList = New TGIS_StringList()
            ...
            Dim lrtg As TGIS_LayerVector = ortg.Route_4(names)

            If (lrtg IsNot Nothing) Then
                Dim b As Boolean = False
                Dim dist As Integer = 0
                Dim time As Integer = 0
                For Each shp As TGIS_Shape In lrtg.Loop_3(lrtg.Extent, "( type = 'route' )")
