...
Namespace WMTSManager
    ...
    Public Class WMTSForm
        ...
        Public Function getGIS() As AxTatukGIS_XDK11.AxTGIS_ViewerWnd
            Return GIS
        End Function
...
#End Region
        ...
        Private Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
            Dim wmts As TGIS_LayerWMTS
            Dim layer As TGIS_StringList
            Dim str As String
            Dim c As TGIS_CharArray
            wmts = New TGIS_LayerWMTS
            tkn = New TGIS_Tokenizer
            str = cbxLayers.Text
            c = New TGIS_CharArray()
            c.SetLength(1)
            c.Value(0) = 59
            tkn.Execute(str, c)
            layer = tkn.Result
            wmts.Path = "[TatukGIS Layer\n" +
                        "Storage=WMTS\n" +
                        "Layer=" + layer.Strings(0) + "\n" +
                        "Url=" + cbxServers.Text + "\n" +
                        "TileMatrixSet=" + layer.Strings(2) + "\n" +
                        "ImageFormat=" + layer.Strings(1) + "\n" +
