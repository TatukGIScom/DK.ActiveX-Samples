...
Namespace Classification
    Public Class WinForm
        ...
        Private Sub InitializeComponent()
            ...
            Me.cbMethod.Items.AddRange(New Object() {"Select ...", "Defined Interval", "Equal Interval", "Geometrical Interval", "Natural Breaks", "K-Means", "K-Means Spatial", "Quantile", "Quartile", "Standard Deviation", "Standard Deviation with Central"})
            ...
            Me.GIS_Legend.Location = New System.Drawing.Point(12, 115)
            ...
            Me.GIS_Legend.Size = New System.Drawing.Size(211, 486)
        ...
        Private Sub fillCbColorRamps()
            ...
            For i As Integer = 0 To GisUtils.GisColorRampList.Count - 1
                ramp_name = GisUtils.GisColorRampList.Items(i).Name
        ...
        Private Function getLayer() As TGIS_Layer
            ...
            If GIS.Items.Count > 0 Then res = TryCast(GIS.Items.Item(0), TGIS_Layer)
            Return res
        End Function
        ...
        Private Sub doClassify(ByVal sender As Object, ByVal e As EventArgs)
            ...
            classifier = (New TGIS_ClassificationFactory).CreateClassifier(lyr)
            classifier.Target = cbField.SelectedItem.ToString()
            classifier.NumClasses = cbClasses.SelectedIndex + 1
            classifier.StartColor = (New TGIS_Color).FromRGB(pStartColor.BackColor.R, pStartColor.BackColor.G, pStartColor.BackColor.B)
            classifier.EndColor = (New TGIS_Color).FromRGB(pEndColor.BackColor.R, pEndColor.BackColor.G, pEndColor.BackColor.B)
            ...
            If chkUseColorRamp.Checked Then
                classifier.ColorRamp = GisUtils.GisColorRampList.Items(cbColorRamp.SelectedIndex).RealizeColorMap(TGIS_ColorMapMode.Continuous, classifier.NumClasses, False)
            Else
